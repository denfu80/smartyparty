    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-purple-50 to-blue-50">
      <div className="w-full max-w-md space-y-8 p-8 bg-white rounded-lg shadow-lg">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Sternenhaus</h1>
        ...
        <div className="text-center text-sm text-gray-500">
          <p>Durch die Anmeldung stimmst du unseren</p>
          <p>Nutzungsbedingungen und Datenschutzrichtlinien zu.</p>
        </div>
      </div>
    </div>
  );
