    ...
    >
      <div className="space-y-6">
        <div className="bg-card border rounded-lg p-6">
          <h1 className="text-3xl font-bold mb-2">NPCs</h1>
          <p className="text-muted-foreground">
            NPC-Interaktionen werden bald verfügbar sein.
          </p>
        </div>
        ...
        <div className="bg-card border rounded-lg p-6">
          ...
          <ul className="list-disc list-inside space-y-2 text-muted-foreground">
            <li>Mit KI-gesteuerten NPCs interagieren</li>
            <li>Dialoge führen und Beziehungen aufbauen</li>
            <li>Quests und Missionen annehmen</li>
            <li>Handelsverträge aushandeln</li>
            <li>Allianzen und Rivalitäten verwalten</li>
          </ul>
        </div>
      </div>
    </GameLayout>
