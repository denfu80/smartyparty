      ...
      <div className="space-y-6">
        <div className="bg-card border rounded-lg p-6">
          ...
          <p className="text-muted-foreground">
            Territoriumsverwaltung wird bald verfügbar sein.
          </p>
        </div>
        ...
        <div className="bg-card border rounded-lg p-6">
          ...
          <ul className="list-disc list-inside space-y-2 text-muted-foreground">
            <li>Übersicht über kontrollierte Stationen</li>
            <li>Territoriale Expansion planen</li>
            <li>Verteidigungsanlagen verwalten</li>
            <li>Einflussgebiete visualisieren</li>
          </ul>
        </div>
      </div>
    </GameLayout>
